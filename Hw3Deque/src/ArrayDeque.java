...
public class ArrayDeque<T> {
    ...
    public void addFirst(T data) {
        if (data == null) {
            ...
            for (int i = 0; i < size; i++) {
                tempArray[i + 1] = backingArray[mod((front + i), backingArray.length)];
            }
            tempArray[0] = data;
            front = 0;
    ...
    public T removeFirst() {
        if (size == 0) {
            ...
            T dataInFirst = backingArray[front];
    ...
    public T removeLast() {
        if (size == 0) {
            ...
            T dataInLast = backingArray[mod((front + size - 1), backingArray.length)];
